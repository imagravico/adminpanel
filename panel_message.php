    ...
    <div class="row">
            ...
            <div class="row">
                        ...
                        <div class="widget-advanced">
                            ...
                            <div class="widget-header text-center themed-background-dark-default">
                                ...
                                <h3 class="widget-content-light">
                                    <a href="panel_message_edit.php" class="themed-color-default">Happy Birthday</a><br>
                                    <small>Client</small>
                                </h3>
                            </div>
                            <!-- END Widget Header -->
                            ...
                            <div class="widget-main ">
                                <a href="panel_message_edit.php" class="widget-image-container animation-fadeIn">
                                    <span class="widget-icon themed-background-default"><i class="fa fa-envelope"></i></span>
                                </a>
                            </div>
                            <!-- END Widget Main -->
                        </div>
                    ...
                    <div class="widget">
						<div class="widget-advanced">
                            ...
                            <div class="widget-header text-center themed-background-dark-fire">
                                <div class="widget-options"></div>
                                <h3 class="widget-content-light">
                                    <a href="panel_message_edit.php" class="themed-color-fire">Merry Christmas</a><br>
                                    <small>Client</small>
                                </h3>
                            </div>
                            <!-- END Widget Header -->
                            ...
                            <div class="widget-main ">
                                <a href="panel_message_edit.php" class="widget-image-container animation-fadeIn">
                                    <span class="widget-icon themed-background-fire"><i class="fa fa-envelope"></i></span>
                                </a>
                            </div>
                            <!-- END Widget Main -->
                        </div>
                ...
                <div class="col-sm-4">
                    <div class="widget">
						<div class="widget-advanced">
                            <!-- Widget Header -->
                            <div class="widget-header text-center themed-background-dark-forest">
                                <div class="widget-options"></div>
                                <h3 class="widget-content-light">
                                    <a href="panel_message_edit.php" class="themed-color-forest">Happy New Year</a><br>
                                    <small>Client</small>
                                </h3>
                            </div>
                            <!-- END Widget Header -->
                            ...
                            <div class="widget-main ">
                                <a href="panel_message_edit.php" class="widget-image-container animation-fadeIn">
                                    <span class="widget-icon themed-background-forest"><i class="fa fa-envelope"></i></span>
                                </a>
                            </div>
                            <!-- END Widget Main -->
                        </div>
                    ...
                    <div class="widget">
						<div class="widget-advanced">
                            ...
                            <div class="widget-header text-center themed-background-dark-autumn">
                                <div class="widget-options"></div>
                                <h3 class="widget-content-light">
                                    <a href="panel_message_edit.php" class="themed-color-autumn">Anniversary Day</a><br>
                                    <small>Website</small>
                                </h3>
                            </div>
                            <!-- END Widget Header -->
                            ...
                            <div class="widget-main ">
                                <a href="panel_message_edit.php" class="widget-image-container animation-fadeIn">
                                    <span class="widget-icon themed-background-autumn"><i class="fa fa-envelope"></i></span>
                                </a>
                            </div>
                            <!-- END Widget Main -->
                        </div>
		...
		<div class="col-lg-2">
			...
			<div class="row text-center">
				<div class="col-xs-12">
					<a href="panel_message_edit.php" class="widget widget-hover-effect2">
				...
				<div class="col-xs-12">
					<a href="javascript:void(0)" class="widget widget-hover-effect2">
						...
						<div class="widget-extra-full"><span class="h2 themed-color-dark animation-expandOpen">4</span></div>
					</a>
				</div>
			</div>
        </div>
