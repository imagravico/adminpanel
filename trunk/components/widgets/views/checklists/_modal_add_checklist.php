...
<div id="modal-checklist-add" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="checklist-content form-horizontal form-bordered">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-xs-12 text-right">
                            ...
                            <button type="button" class="btn btn-sm btn-primary btn-add-checklist" data-belong-to="<?php echo $belong_to; ?>" data-cowid="<?php echo \Yii::$app->request->get('id'); ?>">Save Changes</button>
                        </div>
                    </div>
                </div>
            </div>
