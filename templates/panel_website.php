    ...
    <div class="row">
                        ...
                        <div class="widget-advanced">
                            ...
                            <div class="widget-header text-center themed-background-dark-default">
                                ...
                                <h3 class="widget-content-light">
                                    <a href="panel_website_edit.php" class="themed-color-default">undefiniert.ch</a><br>
                    ...
                    <div class="widget">
						<div class="widget-advanced">
                            ...
                            <div class="widget-header text-center themed-background-dark-fire">
                                <div class="widget-options"></div>
                                <h3 class="widget-content-light">
                                    <a href="panel_website_edit.php" class="themed-color-fire">domain.com</a><br>
                                    <small>Client Name</small>
                                </h3>
                            </div>
                            <!-- END Widget Header -->
                            ...
                            <div class="widget-main ">
                                <a href="panel_website_edit.php" class="widget-image-container animation-fadeIn">
                                    <span class="widget-icon themed-background-fire"><i class="fa fa-globe"></i></span>
                                </a>
                            </div>
                            <!-- END Widget Main -->
                        </div>
                    ...
                    <div class="widget">
						<div class="widget-advanced">
                            ...
                            <div class="widget-header text-center themed-background-dark-forest">
                                <div class="widget-options"></div>
                                <h3 class="widget-content-light">
                                    <a href="panel_website_edit.php" class="themed-color-forest">ersparniskasse-schaffhausen.ch</a><br>
                                    <small>Client Name</small>
                                </h3>
                            </div>
                            <!-- END Widget Header -->
                            ...
                            <div class="widget-main ">
                                <a href="panel_website_edit.php" class="widget-image-container animation-fadeIn">
                                    <span class="widget-icon themed-background-forest"><i class="fa fa-globe"></i></span>
                                </a>
                            </div>
                            <!-- END Widget Main -->
                        </div>
                    ...
                    <div class="widget">
						<div class="widget-advanced">
                            ...
                            <div class="widget-header text-center themed-background-dark-autumn">
                                <div class="widget-options"></div>
                                <h3 class="widget-content-light">
                                    <a href="panel_website_edit.php" class="themed-color-autumn">eltern-fuer-bilingualitaet.ch</a><br>
                                    <small>Client Name</small>
                                </h3>
                            </div>
                            <!-- END Widget Header -->
                            ...
                            <div class="widget-main ">
                                <a href="panel_website_edit.php" class="widget-image-container animation-fadeIn">
                                    <span class="widget-icon themed-background-autumn"><i class="fa fa-globe"></i></span>
                                </a>
                            </div>
                            <!-- END Widget Main -->
                        </div>
		...
		<div class="col-lg-2">
			...
			<div class="row text-center">
				<div class="col-xs-12">
					<a href="panel_website_edit.php" class="widget widget-hover-effect2">
